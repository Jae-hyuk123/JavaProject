...
public class LoginUI extends javax.swing.JFrame {
    ...
    private void jButtonForSignUpActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonForSignUpActionPerformed
        // TODO add your handling code here:
        SignUpUI signUpDialog = new SignUpUI(this, true);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String validFirstName, validLastName, validEMail, validID;
        validFirstName =  validLastName = validEMail = validID = null;
        ...
        try(Scanner scan = new Scanner(file))
        {
            while(scan.hasNextLine())
            {
                ...
                if(id.equals(parts[3]))
                {
                    if(password.equals(parts[4]))
                    {
                        idValidation = true;
            ...
            { 
                ...
                LoginInformation information = new LoginInformation(validFirstName, validLastName, validEMail, validID);
